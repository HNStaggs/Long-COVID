...
# Run K means
set.seed(2)
kmns_symp <- kmeans(clean[ , c(184:186)], centers = 6)  # Proportion of sleep, mental health, and physical symptoms
...
# Visualize clusters
fviz_cluster(kmns_symp, data = clean[ , c(184:186)], geom = c('point','text')) + theme_minimal()
